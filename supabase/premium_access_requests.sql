create table if not exists public.premium_access_requests (
  ...
  pack_key text not null check (pack_key in ('germany_top_3', 'england_top_4', 'italy_top_3', 'spain_top_4', 'france_top_3', 'portugal_top_3', 'netherlands_top_3', 'belgium_top_3', 'premium_full')),
...
check (pack_key in ('germany_top_3', 'england_top_4', 'italy_top_3', 'spain_top_4', 'france_top_3', 'portugal_top_3', 'netherlands_top_3', 'belgium_top_3', 'premium_full'));
...
begin
  ...
  if target_pack_key not in ('germany_top_3', 'england_top_4', 'italy_top_3', 'spain_top_4', 'france_top_3', 'portugal_top_3', 'netherlands_top_3', 'belgium_top_3', 'premium_full') then
...
begin
  ...
  if v_request.pack_key not in ('germany_top_3', 'england_top_4', 'italy_top_3', 'spain_top_4', 'france_top_3', 'portugal_top_3', 'netherlands_top_3', 'belgium_top_3', 'premium_full') then
    raise exception 'invalid_pack_key';
  end if;
