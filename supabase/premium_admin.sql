...
begin
  ...
  where access.pack_key in ('germany_top_3', 'england_top_4', 'italy_top_3', 'spain_top_4', 'france_top_3', 'portugal_top_3', 'netherlands_top_3', 'belgium_top_3', 'turkey_top_3', 'premium_full')
