...
export default function MatchDetailClient({ stadium }: MatchDetailClientProps) {
    ...
    return (
        <section className="site-card overflow-hidden">
            <div className="border-b border-white/5 p-5 md:p-6">
                ...
                <h2 className="mt-2 text-2xl font-semibold tracking-tight">Venue i din tur</h2>
                <p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--muted)]">
                    Brug samme besøgsstatus her som i `Stadions`, `Min tur`, `Kort` og stadium detail, så hele Tribunetour hænger sammen.
                </p>
            </div>
