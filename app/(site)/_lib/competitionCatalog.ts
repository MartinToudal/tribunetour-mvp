...
export const competitionCatalog: CompetitionCatalogEntry[] = [
  ...
  { id: 'tr-super-lig', countryCode: 'tr', leaguePackId: 'turkey_top_3', name: 'Süper Lig', type: 'domestic_league', level: 1, groupKey: null, sortOrder: 90, isPrimaryDomestic: true, isPremiumEligible: true, aliases: ['süper lig', 'super lig'] },
  { id: 'tr-1-lig', countryCode: 'tr', leaguePackId: 'turkey_top_3', name: '1. Lig', type: 'domestic_league', level: 2, groupKey: null, sortOrder: 91, isPrimaryDomestic: true, isPremiumEligible: true, aliases: ['1. lig', '1 lig', 'tff 1. lig'] },
  { id: 'tr-2-lig-beyaz-grup', countryCode: 'tr', leaguePackId: 'turkey_top_3', name: '2. Lig Beyaz Grup', type: 'domestic_league', level: 3, groupKey: 'beyaz', sortOrder: 92, isPrimaryDomestic: true, isPremiumEligible: true, aliases: ['2. lig beyaz grup', '2 lig beyaz grup', 'tff 2. lig white group'] },
  { id: 'tr-2-lig-kirmizi-grup', countryCode: 'tr', leaguePackId: 'turkey_top_3', name: '2. Lig Kırmızı Grup', type: 'domestic_league', level: 3, groupKey: 'kirmizi', sortOrder: 93, isPrimaryDomestic: true, isPremiumEligible: true, aliases: ['2. lig kırmızı grup', '2. lig kirmizi grup', '2 lig kirmizi grup', 'tff 2. lig red group'] },
  { id: 'tr-1-lig-playoffs', countryCode: 'tr', leaguePackId: 'turkey_top_3', name: '1. Lig - Slutspil', type: 'domestic_league', level: null, groupKey: 'playoff', sortOrder: 94, isPrimaryDomestic: false, isPremiumEligible: true, aliases: ['1. lig slutspil', '1. lig playoffs', 'tff 1. lig playoffs'] },
